...
public:
	...
	//VARKRIABLEN.
	int M_AimEnable, M_Aim_TeamKill, M_Aim_IgnoreFriends, M_Aim_Silent, M_Aim_TeamShoot, M_TriggerBot, M_AutoPistol, M_NoSpread, M_NoRecoil, M_AutoReload, M_ESP_Box,  M_ESP_Name, M_ESP_Health, M_ESP_Weapons, M_NameChanger, M_Bhop, M_FreezeHack, M_DisconnectSpam, M_ClientSpectate, M_VoiceChatSpam, M_TextChatImitator, M_TextChatTeam, M_ChatSpam, M_Aim_KillNPC, M_ESP_NPCs, M_ESP_Players, M_ESP_ViewESP, M_Aim_KillPlayer, M_Aim_IgnoreAmmo, M_Aim_Correct, M_AntiAim;	
	int S_CrossHair;
