...
public:
	...
	//Menu Variables.
	int M_AimEnable, M_Aim_TeamKill, M_Aim_Silent, M_TriggerBot, M_AutoPistol, M_NoSpread, M_AutoReload, M_ESP,  M_ESP_Name, M_ESP_Health, M_ESP_HealthBar, M_ESP_3D, M_ESP_Weapons, M_NameChanger, M_Bhop, M_FreezeHack, M_SpeedHack, M_FastJoin, M_DisconnectSpam, M_ClientSpectate, M_InfoBox, S_SpeedHack, S_CrossHair, M_VoiceChatSpam, M_VoiceChatImitator, M_TextChatImitator, M_TextChatTeam, M_ChatSpam, M_FakeLag, M_Aim_KillNPC, M_ESP_NPCs, M_ESP_Players;	
