...
DWORD dw_GetUserCmd = NULL;

typedef bool ( __fastcall *OriginalCNetChan_ProcessMessages)( void* thisptr, int edx, bf_read&buf );
typedef const char *( __fastcall *OriginalC_BaseEnt_Classname )( void* thisptr, int edx );
typedef void ( __fastcall *OriginalC_BaseEnt_FireBullets )( void* thisptr, int edx, const FireBulletsInfo_t  &info );
...
typedef bool ( __fastcall *OriginalSendData )( void* thisptr, int edx, bf_write &msg, bool bReliable);
...
typedef HRESULT (__fastcall* Present_T)( void* thisptr, int edx, LPDIRECT3DDEVICE9 device, const RECT* rect_source, const RECT* rect_dest, HWND dest_hwnd, const RGNDATA* pDirtyRegion);

OriginalCNetChan_ProcessMessages CNetChan_ProcessMessagesFn;
OriginalC_BaseEnt_Classname C_BaseEnt_Classname;
OriginalC_BaseEnt_FireBullets C_BaseEnt_FireBulletsFn;
OriginalCL_QueueDownload CL_QueueDownloadFn;
OriginalCreateMove CreateMoveFn;
OriginalSendData SendDataFn;
