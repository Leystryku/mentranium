...
public:
	...
	//VARKRIABLEN.
	int M_AimEnable, M_Aim_TeamKill, M_Aim_RandomHitgroup, M_Aim_Silent, M_Aim_Hitscan, M_Aim_PSilent, M_Aim_TeamShoot, M_TriggerBot, M_AutoPistol, M_NoSpread, M_NoRecoil, M_AutoReload, M_ESP_Box,  M_ESP_Name, M_ESP_Health, M_ESP_Weapons, M_NameChanger, M_Bhop, M_Bhop_Perfect, M_FreezeHack, M_DisconnectSpam, M_ClientSpectate, M_VoiceChatSpam, M_SpeedHack, M_TextChatImitator, M_TextChatTeam, M_ChatSpam, M_ChatJammer, M_Aim_KillNPC, M_ESP_NPCs, M_ESP_Players, M_ESP_ViewESP, M_Aim_KillPlayer, M_Aim_IgnoreAmmo, M_Aim_Correct, M_AntiAim, M_PropKill, M_FlashlightSpam;	

	int S_Aim_Smooth, S_Aim_FOV, S_CrossHair, S_SpeedHack, S_HitGroup, S_TargetMode;

	std::string T_CustomESP, T_ChatSpam, T_VoiceChatSpam;

	int TabCount, CheckCount, SliderCount, TextBoxCount;
	char* ActiveName;
	char textCharBuf[9999];
	POINT Cur;
	bool ClickToggle;
	int sizeoftab;
